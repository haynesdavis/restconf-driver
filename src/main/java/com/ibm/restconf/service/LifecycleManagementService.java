        ...
        if(jwt != null) {
           /* if ("Get".equalsIgnoreCase(executionRequest.getLifecycleName())) {
            ...
            if ("Create".equalsIgnoreCase(executionRequest.getLifecycleName())) {
                ...
                externalMessagingService.sendDelayedExecutionAsyncResponse(new ExecutionAsyncResponse(requestId, ExecutionStatus.COMPLETE, null, Collections.emptyMap(), Collections.emptyMap()), executionRequest.getTenantId(), rcDriverProperties.getExecutionResponseDelay());
